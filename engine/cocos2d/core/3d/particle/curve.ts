...
export class AnimationCurve {
    ...
    constructor (keyFrames = null) {
        if (keyFrames) {
            ...
            this.keyFrames.push(new Keyframe(defaultKFStart.time, defaultKFStart.value, defaultKFStart.inTangent, defaultKFStart.outTangent));
            this.keyFrames.push(new Keyframe(defaultKFEnd.time, defaultKFEnd.value, defaultKFEnd.inTangent, defaultKFEnd.outTangent));
        }
