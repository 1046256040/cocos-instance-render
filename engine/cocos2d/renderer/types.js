...
const PARTICLE_VFX_DEFINE_LABELS = {
    USE_BASE_ROTATION_UV: "主纹理 UV 旋转",
    USE_BASE_COLOR_SATURATION: "主纹理颜色饱和度",
    USE_BASE_CUSTOM_DATA: "主纹理自定义数据",
    USE_MASK: "遮罩",
    USE_MASK_UV_CLAMP: "遮罩图 UV 限制（0-1）",
    USE_MASK_ROTATION_UV: "遮罩图 UV 旋转",
    USE_MASK_CUSTOM_DATA: "遮罩自定义数据",
    USE_DISTORTION: "扭曲",
    USE_DISTORTION_ROTATION_UV: "扭曲图 UV 旋转",
    USE_DISTORTION_CUSTOM_DATA: "扭曲自定义数据",
    USE_DISTORTION_CUSTOM_INTENSITY_DATA: "扭曲强度数据",
    USE_DISSOLVE: "溶解",
    USE_DISSOLVE_ROTATION_UV: "溶解图 UV 旋转",
    USE_DISSOLVE_CUSTOM_DATA: "溶解自定义数据",
    USE_DISSOLVE_CUSTOM_INTENSITY_DATA: "溶解强度数据",
    USE_ADDITION_DISSOLVE_MAP: "附加溶解",
    USE_ADDITION_DISSOLVE_ROTATION_UV: "附加溶解图 UV 旋转",
    USE_ADDITION_DISSOLVE_CUSTOM_DATA: "附加溶解自定义数据",
    USE_ADDITION_DISSOLVE_CUSTOM_INTENSITY_DATA: "附加溶解强度数据",
    USE_ALPHA_TEST: "开启透明度测试",
};
...
export function getInspectorProps(prop) {
    ...
    editor.displayName = editor.displayName || PARTICLE_VFX_DEFINE_LABELS[prop.name] || prop.name;
