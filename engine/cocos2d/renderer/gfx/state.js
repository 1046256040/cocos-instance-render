...
export default class State {
  constructor(device) {
    ...
    this.vertexBufferDivisors = new Array(device._caps.maxVertexStreams);
  ...
  static initDefault(device) {
    ...
    _default.vertexBufferDivisors = new Array(device._caps.maxVertexStreams);
  ...
  set (cpy) {
    ...
    for (let i = 0; i < cpy.vertexBufferDivisors.length; ++i) {
      this.vertexBufferDivisors[i] = cpy.vertexBufferDivisors[i];
    }
